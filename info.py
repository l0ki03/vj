...
API_ID = int(environ.get('API_ID', '21295175'))
API_HASH = environ.get('API_HASH', '75b6bf5a46e844dbf2952fbfb8f19184')
BOT_TOKEN = environ.get('BOT_TOKEN', "7259470022:AAHqrgD_8c9NfVqirxemrt9qm76MCXMS8Z4")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002412155111'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5351751249').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002412155111').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002412155111')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002412155111')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002412155111')).split()]
